...
<body>
   <div id="hero">
    <div class="container">
        <div class="row align-items-center text-center">
            <div class="col-md-6">
                <h1 class="display-4">Mar Laundry</h1>
                <p class="mb-5">Pelayanan yang cepat dan murah</p>
                
                <a class="btn-lg btn-primary" href="/login">Login</a>
            </div>
            <div class="col-md-6">
   ...
   <div id="footer">
       <p class="text-center">Copyright Umar 2023</p>
   </div>
</body>
</html>